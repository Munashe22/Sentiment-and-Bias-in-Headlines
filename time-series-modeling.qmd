...
*Model 1 : ARIMA (0,1,1) has the lowest AIC indicating to be the best model for bias according to this manual selection process*
...
```{r}
model_manual_bias <- capture.output(sarima(bias_monthly_ts, 0,1,1))
```
